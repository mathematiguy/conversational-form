...
The rules and research that informed the project are also included in the `/research` directory, and you can find the (currently online) website at `https://thinktank.co.nz/startabiz/`.
